...
function setCelsiusUnitFormat() {
  ...
  firstFutureDegreesDay.innerHTML = convertFahrenheitToCelsius(
    firstFutureDegreesDay.innerHTML
  );
  secondFutureDegreesDay.innerHTML = convertFahrenheitToCelsius(
    secondFutureDegreesDay.innerHTML
  );
  thirdFutureDegreesDay.innerHTML = convertFahrenheitToCelsius(
    thirdFutureDegreesDay.innerHTML
  );
  currFeelsLike.innerHTML = `${convertFahrenheitToCelsius(
    thirdFutureDegreesDay.innerHTML
  )}°`;
}
...
function setFahrenheitUnitFormat() {
  ...
  firstFutureDegreesDay.innerHTML = convertCelsiusToFahrenheit(
    firstFutureDegreesDay.innerHTML
  );
  secondFutureDegreesDay.innerHTML = convertCelsiusToFahrenheit(
    secondFutureDegreesDay.innerHTML
  );
  thirdFutureDegreesDay.innerHTML = convertCelsiusToFahrenheit(
    thirdFutureDegreesDay.innerHTML
  );
  currFeelsLike.innerHTML = `${convertCelsiusToFahrenheit(
    thirdFutureDegreesDay.innerHTML
  )}°`;
}
